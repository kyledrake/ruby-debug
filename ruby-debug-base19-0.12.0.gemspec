...
Gem::Specification.new do |s|
  ...
  s.date = "2012-03-23"
  s.description = "ruby-debug-base19 is a fast implementation of the standard Ruby debugger debug.rb.\nIt is implemented by utilizing a new Ruby C API hook. The core component\nprovides support that front-ends can build on. It provides breakpoint\nhandling, bindings for stack frames among other things.\n"
  ...
  s.files = ["AUTHORS", "CHANGES", "LICENSE", "README", "Rakefile", "ext/ruby_debug/breakpoint.c", "ext/ruby_debug/extconf.rb", "ext/ruby_debug/ruby_debug.c", "ext/ruby_debug/ruby_debug.h", "lib/ChangeLog", "lib/ruby-debug-base.rb", "test/base/base.rb", "test/base/binding.rb", "test/base/catchpoint.rb"]
